...
- [ ] **Week grid stale planned session** — shows planned strength even when mountain day replaced it
...
- [ ] **Google Calendar integration** — `scripts/gcal.py` CLI works. Wire into CCD so training sessions auto-create calendar events.
